  ...
  return (
    <div className="">
        ...
        <div className='w-96 p-2'>
            <div className="h-26 bg-gray-200 mb-10 rounded-md overflow-hidden">
                <div className="m-2"><IoMdCloseCircleOutline /></div>
        ...
        <div className="max-w-xl rounded-lg shadow-xl mb-10">
            <a href="#">
